...
class PayoutViewModel : ViewModel() {
    ...
    var mResponse: MutableLiveData<ModelPayouts?>
    ...
    fun getAllPayouts(mToken: String) {
        viewModelScope.launch {

            val mResp = async {

                mRepository.getPayoutList(mToken)
            }
     ...
     * ***/
    fun liveResponse(): LiveData<ModelPayouts?> = mResponse

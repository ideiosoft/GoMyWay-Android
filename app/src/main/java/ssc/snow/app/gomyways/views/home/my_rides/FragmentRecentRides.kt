...
import ssc.snow.app.gomyways.views.home.my_rides.adapter.AdapterRecentRides

class FragmentRecentRides : Fragment() {

    private var mLinearLayoutManager: LinearLayoutManager? = null
    private lateinit var mAdapter: AdapterRecentRides
    ...
    fun setUpRecycleView(data: List<ModelMyRides.Data?>?) {
        ...
        // Set adapter
        activity!!.let {
            mAdapter = AdapterRecentRides(activity!!, data)

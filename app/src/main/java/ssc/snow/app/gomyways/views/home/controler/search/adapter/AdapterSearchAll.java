...
public class AdapterSearchAll extends RecyclerView.Adapter<AdapterSearchAll.MyViewHolder> {
    ...
    public AdapterSearchAll(Activity context) {
    ...
    @NonNull
    @Override
    public AdapterSearchAll.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.layout_item_search_trips, viewGroup, false);

        return new AdapterSearchAll.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterSearchAll.MyViewHolder holder, int i) {
